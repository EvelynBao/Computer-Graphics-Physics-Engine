...
void showInclinedPlane(struct world* jello) {
    ...
    glColor4f(0.1, 0.8, 0.3, 0.5); // green
    double a = jello->a, b = jello->b, c = jello->c, d = jello->d;
    glEnable(GL_BLEND);
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);

    // 4 points
    struct point v1 = solvePlaneIntersection(a, b, c, d, -2, -2);
    struct point v2 = solvePlaneIntersection(a, b, c, d, 2, -2);
    struct point v3 = solvePlaneIntersection(a, b, c, d, 2, 2);
    struct point v4 = solvePlaneIntersection(a, b, c, d, -2, 2);
