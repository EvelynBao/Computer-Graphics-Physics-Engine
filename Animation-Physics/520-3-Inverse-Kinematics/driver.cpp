...
void saveScreenshot(int windowWidth, int windowHeight, char* filename)
{
    ...
    snprintf(path, sizeof(path), "C:/Users/bry15/AAA/study/USC/520/hw/hw3/cs520-hw3-ik/starter/VS2017/screenshots/%s", filename);
...
static void idleFunction()
{
  ...
  s[6] = 48 + sprite % 10;
  //printf("%i and %i", totalframe, sprite);
  if (totalframe % frequency == 0) {
